...
class Maddi extends Munop { // ajout d'une constante
	int n;
	Maddi(int n) { this.n = n;}
	public String toString() { return "add $" + n; } 
}
class Msetei extends Munop { // égalité avec une constante (equal immediate)
	int n;
	Msetei(int n) { this.n = n;}
	public String toString() { return "sete $" + n; } 
}

class Msetnei extends Munop { // différence avec une constante (not equal immediate)
	int n;
