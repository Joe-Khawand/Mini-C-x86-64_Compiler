...
public class Register {
	...
	static { for (Register r: parameters) caller_save.add(r); }
	...
	static {
		...
		callee_saved.add(r13); callee_saved.add(r14); callee_saved.add(r15);
	}
  ...
  static final Register tmp1 = new Register("%r10");
